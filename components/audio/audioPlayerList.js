...
const AudioPlayerList = ({ file }) => {
  ...
  return (
    ...
    <div id="jp_container_1" className="jp-audio" role="application" aria-label="media player">
      ...
      <div className="jp-type-single audio">
        <div className="jp-gui jp-interface  d-flex align-items-center justify-content-center" style={{ width: "100%", height: "100px" }}>
          ...
          <div className="container d-flex align-items-center justify-content-center" >
            ...
            <i className="fa fa-forward fa-2x mr-4 cursor-pointer" aria-hidden="true"></i>
              ...
              <i className="fa fa-forward fa-2x ml-4 mr-4 cursor-pointer" aria-hidden="true"></i>
            </div>
